...
** HTML export commands.Оформление документа
...
C-c C-e h h (org-html-export-to-html)вход в меню конвертации org-mode
...
Note taken on [2013-09-02 Mon 23:54] My note here
...
Скачиваем и устанавливаем Sumatra PDF.

Эта легковесная программа позволяет просматривать PDF-документы, DJVU, FB2 и т.д.
...
При нажатии ctrl+В происходит трансляция и, если нет ошибок, открывается свёрстанный PDF. Ctrl+shift+В — выбор типа сборки.
